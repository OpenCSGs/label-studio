...
class FileUpload(models.Model):
    ...
    def format_could_be_tasks_list(self):
        ...
        logger.info('Read tasks list from CSV or txt file {}'.format('.csv, .tsv, .txt'))
        return self.format in ( '.tsv', )
    ...
    def read_tasks(self, file_as_tasks_list=True):
        ...
        try:
            ...
            if file_format == '.csv' and file_as_tasks_list:
                ...
                logger.info('Read tasks list from CSV  {}'.format('.csv,'))
                ...
                logger.info('Read tasks list from CSV  {}'.format('.json'))
                tasks = self.read_task_from_uploaded_file()
