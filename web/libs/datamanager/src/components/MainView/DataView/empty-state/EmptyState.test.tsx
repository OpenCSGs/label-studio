...
const mockT = (key: string) => {
  const translations: Record<string, string> = {
    "dataManager.importDataToGetStarted": "Import data to get your project started",
    "dataManager.connectStorageOrUpload": "Connect your cloud storage or upload files from your computer",
    "dataManager.connectCloudStorage": "Connect Cloud Storage",
    "dataManager.seeDocsOnImporting": "See docs on importing data",
    "dataManager.import": "Import",
    "dataManager.noTasksFound": "No tasks found",
    "dataManager.tryAdjustingFilters": "Try adjusting or clearing the filters to see more results",
    "dataManager.clearFilters": "Clear Filters",
    "dataManager.noTasksForReview": "No tasks available for review or labeling",
    "dataManager.tasksImportedWillAppear": "Tasks imported to this project will appear here",
    "dataManager.startLabelingTasks": "Start labeling tasks",
    "dataManager.tasksLabeledWillAppear": "Tasks you've labeled will appear here",
    "dataManager.labelAllTasks": "Label All Tasks",
    "dataManager.noTasksAvailable": "No tasks available",
    "dataManager.tasksAssignedWillAppear": "Tasks assigned to you will appear here",
    "dataManager.tasksWillAppearWhenAvailable": "Tasks will appear here when they become available",
    "storage.amazonS3": "Amazon S3",
    "storage.googleCloudStorage": "Google Cloud Storage",
    "storage.azureBlobStorage": "Azure Blob Storage",
